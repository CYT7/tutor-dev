  ...
  <el-row :gutter="20">
    ...
    <el-col style="margin-top: -6%">
      <div style="margin-top:8%;margin-left:10%;" align="center" class="app-container">
        ...
        <el-form :model="addForm" ref="addFormRef" :rules="addFormRules" label-width="auto" label-position="left" style="width: 80%;margin: auto;">
          <div v-if="active ===0">
            <el-form-item label="真实姓名" prop="realName"><el-input v-model="addForm.realName"></el-input></el-form-item>
            <el-form-item label="教学经验(年)" prop="experience"><el-input v-model="addForm.experience"></el-input></el-form-item>
            <el-form-item label="目前年龄(岁)" prop="age"><el-input v-model="addForm.age"></el-input></el-form-item>
            <el-form-item label="擅长科目" prop="goodAt">
              <el-select v-model="addForm.goodAt" placeholder="请选择" style="float: left">
                <el-option
