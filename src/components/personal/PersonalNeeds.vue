<template>
  <el-row :gutter="20">
    <el-col :span="20"><Header></Header></el-col>
    <el-col :span="20">
    ...
    <div style="margin-top: 20px" align="center">
      <el-table :data="resultsMap.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 80%" height="500"><!--height可实现固定表头的表格-->
    ...
    <el-dialog title="新建需求" :visible.sync="dialogVisible2" width="30%" :before-close="handleClose">
